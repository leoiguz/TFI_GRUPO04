    ...
    fetch("/DashBoard/ObtenerResumen")
        ...
        .then(responseJson => {
            ...
            if (responseJson.estado) {
                ...
                $("#totalInventarios").text(d.totalInventarios)
                $("#totalArticulos").text(d.totalArticulos)
                ...
                let piechar_labels;
                let piechart_data;
                if (d.inventariosTopUltimaSemana.length > 0) {
                    piechar_labels = d.inventariosTopUltimaSemana.map((item) => { return item.nombreArticulo })
                    piechart_data = d.inventariosTopUltimaSemana.map((item) => { return item.cantidad })
                } else {
                ...
                // Pie Chart Example
                let controlInventario = document.getElementById("charInventarios");
                let myPieChart = new Chart(controlInventario, {
                    type: 'doughnut',
                    data: {
