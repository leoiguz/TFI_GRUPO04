        ...
        fetch("/Marca/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Listo!", "El marca fue creado", "success")
                } else {
        ...
        fetch("/Marca/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Listo!", "El marca fue modificado", "success")
                } else {
                    swal("Lo sentimos", responseJson.mensaje, "error")
                }
            })
...
$("#tbdata tbody").on("click", ".btn-eliminar", function () {
    ...
    swal({
        title: "¿Esta seguro?",
        text: `Eliminar el marca "${data.descripcion}"`,
        type: "warning",
                ...
                fetch(`/Marca/Eliminar?IdMarca=${data.idMarca}`, {
                    ...
                    .then(responseJson => {
                        if (responseJson.estado) {
                            ...
                            swal("Listo!", "El marca fue eliminado", "success")
                        } else {
                            swal("Lo sentimos", responseJson.mensaje, "error")
                        }
                    })
